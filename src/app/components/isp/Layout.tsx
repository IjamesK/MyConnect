        ...
        <div className="sticky top-0 z-20 bg-white border-b border-[#E2E8F0] px-4 h-14 flex items-center justify-between shrink-0">
          {showBack ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <span style={{ fontFamily: "'Inter Tight', system-ui, sans-serif", fontWeight: 700 }} className="text-[#0F172A] text-sm">
                MyConnect
              </span>
            </div>
          )}
            ...
            {navItems.map(({ icon: Icon, label, path }) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <span
                    className={`text-[10px] font-medium ${active ? "text-[#0057B8]" : "text-[#94A3B8]"}`}
                  >
                    {label}
                  </span>
                </button>
