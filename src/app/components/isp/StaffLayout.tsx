  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] flex">
        ...
        <div className="px-6 py-5 border-b border-white/10">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-[10px] text-[var(--color-muted)] font-medium tracking-wide uppercase">Staff Portal</div>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 py-4 border-t border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[var(--color-muted)] text-[10px]">{staffRole}</div>
            </div>
            <button onClick={() => navigate("/")} className="text-[var(--color-muted)] hover:text-white">
              <LogOut size={14} />
            </button>
          </div>
        </div>
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        {/* Top bar */}
      <div className="bg-[var(--color-surface)] border-b border-[var(--color-border)] px-8 h-16 flex items-center justify-between shrink-0 sticky top-0 z-10">
          <div>
            <h1 style={{ fontFamily: "'Inter Tight', system-ui, sans-serif", fontWeight: 700 }} className="text-[var(--color-text)] text-lg">
              {title}
            </h1>
            {subtitle && <p className="text-[var(--color-muted)] text-xs mt-0.5">{subtitle}</p>}
          </div>
          <div className="flex items-center gap-3">
            <span className="text-xs text-[var(--color-muted)]">Last updated: just now</span>
