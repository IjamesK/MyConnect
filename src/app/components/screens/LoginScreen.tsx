    ...
    <div className="min-h-screen bg-[#E5007D] flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl p-6 space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="e.g. ZTEGD1234567 or 0700123456"
        ...
        <button
          ...
          className="w-full py-3 bg-[#E5007D] hover:bg-[#BE0067] text-white rounded-xl font-semibold text-sm transition-colors shadow-sm active:scale-95"
        >
          Sign In
        </button>
