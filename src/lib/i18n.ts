...
export const translations = {
  ...
  sw: {
    ...
    troubleshoot: "Msaada Binafsi",
    selfHelp: "Msaada Binafsi",
  ...
  lg: {
    ...
    troubleshoot: "Obuyambi Obwangu",
    selfHelp: "Obuyambi Obwangu",
  ...
  fr: {
    ...
    troubleshoot: "Aide personnelle",
    selfHelp: "Aide personnelle",
